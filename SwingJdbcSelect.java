...
public class SwingJdbcSelect extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		SwingJdbcSelect obj = new SwingJdbcSelect();
		obj.setTitle("Swing JDBC Project Select");
		obj.setSize(800,800);
		obj.setVisible(true);
