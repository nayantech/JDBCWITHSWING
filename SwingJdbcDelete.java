...
//Perform JDBC Insert or delete using Swing
//Home system program

public class SwingJdbcDelete extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		SwingJdbcDelete obj = new SwingJdbcDelete();
